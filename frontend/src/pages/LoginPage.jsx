        ...
        <div className="auth-form">
          <div className="form-group">
            ...
            <div className="input-icon-wrap">
              ...
              <input className="input-field input-with-icon" type="email" placeholder="ca.ni@example.com" value={email} onChange={e => setEmail(e.target.value)} />
            </div>
          </div>
          <div className="form-group">
            ...
            <div className="input-icon-wrap">
              ...
              <input className="input-field input-with-icon" type="password" placeholder="••••••••" value={password} onChange={e => setPassword(e.target.value)} />
            </div>
          </div>
          ...
          <button className="btn-primary auth-submit" onClick={() => navigate('/host/dashboard')}>Sign In</button>
