...
const Queue = B.Queue;
let QueueScheduler = B.QueueScheduler || (B.default && B.default.QueueScheduler);
...
try {
  if (QueueScheduler) {
    ...
    console.warn('QueueScheduler not available from bullmq; delayed jobs/retries may be limited.');
  }
} catch (err) {
